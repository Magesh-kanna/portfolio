...
export default function Footer() {
  ...
  return (
    <>
      {/* Mobile Footer (< 768px) with bottom dock spacing */}
      <MobileFooter />

      {/* Desktop Web Footer (>= 768px) */}
      <footer className="hidden md:block py-12 px-4 sm:px-6 lg:px-8 bg-[#070709] border-t border-white/[0.08] relative select-none">
