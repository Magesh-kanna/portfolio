...
import MobileAchievements from "@/components/mobile/MobileAchievements";
...
export default function AchievementsSection() {
  return (
    <section id="achievements" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] relative">
