...
import { MapPin, Sparkles, Award, Smartphone, CheckCircle2, ArrowUpRight } from "lucide-react";
...
export default function AboutSection({}: AboutSectionProps) {
  ...
  return (
    <section id="about" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] relative">
